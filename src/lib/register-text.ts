...
export const labelsID: RegisterLabels = {
  ...
  descDewasa: "Daftar sekarang dan mulai perjalanan investasi emas Anda bersama Public Gold Indonesia.",
  titleAnak: "Pendaftaran Akun Anak",
  descAnak: "Daftarkan anak Anda untuk memulai perjalanan investasi emas bersama Public Gold Indonesia.",
  tabDewasa: "Akun Dewasa",
  tabAnak: "Akun Anak",
  noteAnak: "Catatan: Anak di bawah 18 tahun harus didampingi orang tua atau wali. Setelah anak mencapai usia 18 tahun, akun bisa ditransfer ke nama mereka sendiri.",
  
  parentSectionTitle: "Data Orang Tua / Wali",
  nameLabel: (isAnak) => isAnak ? "Nama Anak" : "Nama Lengkap",
  namePlaceholder: (isAnak) => isAnak ? "Masukkan nama anak (sesuai kartu identitas)" : "Masukkan nama lengkap",
  
  idTypeLabel: "Tipe Identitas",
  icLabel: (isAnak) => isAnak ? "NIK Anak" : "Nomor Identitas",
  icPlaceholder: (isAnak) => isAnak ? "Masukkan NIK anak (maks. 20 digit)" : "Masukkan nomor KTP/Paspor",
  ...
  termsText: "Dengan melanjutkan proses, saya menyetujui bahwa Public Gold Indonesia dapat mengumpulkan, menggunakan informasi yang telah saya bagikan sesuai dengan kebijakan kerahasiaan data dan saya menyetujui serta memenuhi syarat dan ketentuan yang telah saya baca dan pahami.",
  termsLink: "kebijakan kerahasiaan data",
};

export const labelsMY: RegisterLabels = {
  titleDewasa: "Adult Account Registration",
  descDewasa: "Register now and begin your gold wealth journey with Public Gold.",
  titleAnak: "Junior Account Registration",
  descAnak: "Register your child's account to start their gold savings journey.",
  tabDewasa: "Adult Account",
  tabAnak: "Junior Account",
  noteAnak: "Remark: Children below 18 years old must be accompanied by a parent or guardian to open an account. After the child reaches the age of majority (18), the account can be transferred to their name alone.",
  ...
  termsText: "By proceeding, I confirm that the information provided is true, accurate, and complete. I understand that this application is subject to approval by Public Gold. I agree to be bound by the company’s regulations, Terms & Conditions, and Privacy Policy.",
