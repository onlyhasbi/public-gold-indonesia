    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-900 p-4">
      <div className="w-full max-w-sm bg-slate-800 p-8 rounded-xl shadow-2xl border border-slate-700">
        <div className="mb-8 text-center">
          ...
          <p className="text-slate-400 text-sm mt-1">Sistem Proteksi Lapis Ganda</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div>
            ...
            {errors.katasandi && <p className="mt-1 text-sm text-red-400">{errors.katasandi.message}</p>}
          </div>
          <div>
            <label className="block text-sm font-medium text-slate-300 mb-1">Secret Code</label>
            <div className="relative">
              <input
            ...
            {errors.secretCode && <p className="mt-1 text-sm text-red-400">{errors.secretCode.message}</p>}
          </div>
          <button
            type="submit"
        ...
        <p className="mt-4 text-center text-sm text-slate-400">
          Sudah terdaftar? <a onClick={() => navigate({ to: '/admin/login' })} className="text-red-400 hover:text-white hover:underline cursor-pointer transition">Masuk di sini</a>
        </p>
      </div>
    </div>
  )
