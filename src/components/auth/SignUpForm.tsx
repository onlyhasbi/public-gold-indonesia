      ...
      <div className="space-y-4">
        ...
        <div className="relative pb-0.5">
          <div className="flex justify-between items-center px-1 mb-2">
            <label htmlFor="reg_pgcode" className="block text-sm font-semibold text-slate-700">PGCode</label>
          ...
          <div className="relative">
            <input
              ...
              className={cn(
                ...
                signupForm.formState.errors.pgcode && "border-red-500 focus:ring-red-500/30 focus:border-red-500 bg-red-50/30"
              )}
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="space-y-2 relative pb-0.5">
             ...
             <div className={cn("flex w-full bg-slate-50/80 border border-slate-200 rounded-xl focus-within:ring-2 focus-within:ring-red-500/30 focus-within:border-red-400 transition-all duration-200 overflow-hidden", 
               signupForm.formState.errors.no_telpon && "border-red-500 focus-within:ring-red-500/30 focus-within:border-red-500")}>
                <select
          ...
          <div className="relative pb-0.5">
            <label htmlFor="pageid" className="block text-sm font-semibold text-slate-700 mb-2">ID Halaman</label>
            <div className="relative">
              <input
                 id="pageid"
                 ...
                 className={cn("w-full px-4 py-3 bg-slate-50/80 border border-slate-200 rounded-xl text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-red-500/30 focus:border-red-400 transition-all duration-200", 
                 (signupForm.formState.errors.pageid || pageIdError) && "border-red-500 focus:ring-red-500/30 bg-red-50/30"
                 )}
              />
