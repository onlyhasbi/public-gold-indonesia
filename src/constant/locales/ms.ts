...
export const ms: TranslationKeys = {
    ...
    registerForm: {
        ...
        descDewasa: "Daftar sekarang dan mulakan perjalanan kekayaan emas anda bersama Public Gold.",
        titleAnak: "Pendaftaran Akaun Junior",
        descAnak: "Daftar akaun anak anda untuk memulakan perjalanan simpanan emas mereka.",
        tabDewasa: "Akaun Dewasa",
        tabAnak: "Akaun Junior",
        noteAnak: "Nota: Kanak-kanak di bawah 18 tahun mesti ditemani oleh ibu bapa atau penjaga. Selepas anak mencapai usia 18 tahun, akaun boleh dipindahkan atas nama mereka sendiri.",
        ...
        parentNamePlaceholder: "Masukkan nama ibu bapa (seperti dalam kad pengenalan)",
        ...
        termsText: "Dengan meneruskan, saya mengesahkan bahawa maklumat yang diberikan adalah benar, tepat, dan lengkap. Saya faham bahawa permohonan ini tertakluk kepada kelulusan oleh Public Gold. Saya bersetuju untuk terikat dengan peraturan syarikat, Terma & Syarat, dan Dasar Privasi.",
