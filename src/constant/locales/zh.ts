...
export const zh: TranslationKeys = {
    ...
    testimonials: {
        ...
        items: [
            {
                quote: "一个地方就能用3种方式买黄金：储蓄、现金或分期。没有乱七八糟的费用，分期也不需要首付，零利息，也没有滞纳金。感恩在望加锡有这样的服务。",
            ...
            {
                quote: "办公环境舒适，员工友善，金条和金币库存充足。买金不用排队，回购也很快，价格透明。",
                name: "Icha Tarissa",
                title: "客户，万隆",
            },
            {
                quote: "感恩认识了Public Gold，让我终于懂得如何正确储蓄黄金。以前买了也不知道怎么管理。现在，储蓄黄金比乱花钱好多了。",
                name: "Andrianingsih Risa",
                title: "客户，望加锡",
            },
            {
                quote: "有了Public Gold，买黄金再也不用抢了，在家就能买，还能送货上门。很高兴能在PG储蓄。",
            ...
            {
                quote: "Public Gold印尼望加锡分行的服务一直很棒。很喜欢在这里买黄金和金币。",
    ...
    registerForm: {
        ...
        tabDewasa: "成人账户",
        tabAnak: "青少年账户",
        noteAnak: "备注：18岁以下儿童必须由父母或监护人陪同开户。孩子成年（18岁）后，账户可以转入其个人名下。",
        ...
        submitBtn: "提交",
        submittingBtn: "提交中...",
        termsText: "继续操作即表示我确认所提供的信息真实、准确且完整。我理解此申请须经 Public Gold 批准。我同意受公司章程、条款与条件以及隐私政策的约束。",
        termsLink: "隐私政策",
    },
};
